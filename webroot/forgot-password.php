...
$tokenDir = __DIR__ . '/../temp/reset_tokens';
...
function sendResetEmail($email, $token) {
    ...
    General::addRowLog("[Password Reset] Token generato per $email: $resetLink");
...
try {
    switch ($action) {
        case 'request':
            ...
            $user = new User();
            $emailExists = $user->emailExist($email);
        ...
        case 'reset':
            ...
            $result = User::changeUserPassword($tokenData['userId'], $newPassword);
