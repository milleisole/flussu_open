...
--
-- Host: localhost    Database: wofobot01
-- ------------------------------------------------------
...
DROP TABLE IF EXISTS `v10_wf_prj`;
/*!50001 DROP VIEW IF EXISTS `v10_wf_prj`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `v10_wf_prj` AS SELECT
 1 AS `wf_id`,
  1 AS `prj_id` */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `v15_prj_wf_usr`
--

DROP TABLE IF EXISTS `v15_prj_wf_usr`;
/*!50001 DROP VIEW IF EXISTS `v15_prj_wf_usr`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `v15_prj_wf_usr` AS SELECT
 1 AS `wf_id`,
  1 AS `prj_id`,
  1 AS `c83_desc`,
  1 AS `c10_name`,
...
--
-- Temporary table structure for view `v20_prj_wf_all`
--

DROP TABLE IF EXISTS `v20_prj_wf_all`;
/*!50001 DROP VIEW IF EXISTS `v20_prj_wf_all`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `v20_prj_wf_all` AS SELECT
 1 AS `wf_id`,
  1 AS `prj_id`,
  1 AS `prj_name`,
  1 AS `wf_name`,
...
--
-- Final view structure for view `v10_wf_prj`
--
...
/*!50013 DEFINER=`wofouser`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v10_wf_prj` AS select `wf`.`c10_id` AS `wf_id`,ifnull(`pw`.`c85_prj_id`,0) AS `prj_id` from ((`t10_workflow` `wf` left join `t85_prj_wflow` `pw` on(`pw`.`c85_flofoid` = `wf`.`c10_id`)) left join `t83_project` `pr` on(`pr`.`c83_id` = `pw`.`c85_prj_id`)) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `v15_prj_wf_usr`
--
