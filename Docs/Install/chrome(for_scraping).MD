# SCRAPING (OBSOLETO)
> **NOTA:** Questa guida e' obsoleta. Il sistema di scraping ora usa il microservizio
> Flussu Scraper (Playwright). Vedi [../scraper/INSTALL.md](../scraper/INSTALL.md)

## Vecchia procedura (non piu' necessaria)
