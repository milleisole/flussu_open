...
if (!class_exists('\Imagick')) {
    // Crea una classe dummy se Imagick non è disponibile
    class Res_img {
        public function __construct() {
            throw new \Exception('Imagick extension is not installed. Please install php-imagick.');
        }
    }
} else {
	...
	/* ALDUS MODIFY */
		...
		public function __construct($files = null) {
			// Chiama il costruttore parent di Imagick
			parent::__construct($files);
			
			// Aggiungi eventuale logica personalizzata qui
		}
